    ...
    <div class="page-title flex-between-center">
      ...
      <div class="editor-btns">
        <button
          ...
          @click="saveEditedCustomer(editedCustomer)"
        >
...
export default {
  ...
  created () {
    ...
    this.editedCustomer = this.customers[this.customerId].subdivisions[this.subId]
  ...
  methods: {
    ...
    editorExit () {
      this.$router.push('/customers/subdivisions/customer' + this.customerId)
    },

    saveEditedCustomer (customer) {
      firebase.database().ref('/customers/' + this.customerId + '/subdivisions/' + customer.id).set(customer)
        .then(() => {
