                  ...
                  <div class="card-content flex-column-center">
                    ...
                    <div class="input-field editor-input">
                      <input
                        id="surname"
                        type="text"
                        v-model.trim="editedCustomer.surname"
                      >
                    ...
                    <div class="input-field editor-input">
                      <input
                        id="patronymic"
                        type="text"
                        v-model.trim="editedCustomer.patronymic"
                      >
                      <label class="active" for="name"> Отчество</label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-content flex-column-center">
                    ...
                    <div class="input-field editor-input">
                      <input
                        id="post"
                        type="text"
                        v-model.trim="editedCustomer.post"
                      >
                      <label class="active" for="post">Должность</label>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    saveEditedCustomer (customer) {
      ...
      firebase.database().ref('/customers/' + this.customerId + '/subdivisions/' + this.currentSubdivision.id + '/employees/' + customer.id).set(customer)
        .then(() => {
